...
@section('style')
<style>
  .whitepapers-heroimage{
  background: url(https://industry.asianhhm.com/promotions/images/whitepapers-heroimage.jpg);
  width: 100%;
  height: auto;
  min-height: 41rem;
...
<div class="container-fluid breadcrumb-live ">
            <div class="row ">
              <div class="col-12 ">
                  <div class="ahhm-breadcrumb">
                    ...
                    <a href="" class="ahhm-breadcrumb-item">{{trans('messages.whitepapers_title')}}</a>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="container-fluid">
        ...
        <div class="col-12 col-lg-12 ahhm-about">
          <div class="row">
            <div class="col-12">
              <h1 class="mt-0">{{trans('messages.whitepapers_title')}}</h1>
              <div class="whitepapers-heroimage" id="bg-image">
          <h2>Asian Hospital & Healthcare Management<br> <span>An assorted collection of premium quality, high calibre scientific papers for today’s professionals.</span></h2>
            </div>
              <div class="pt-4"></div>
              <p class="mt-2">{{trans('messages.whitepapers_text')}}</p>
            </div>
            @foreach($whitepapers as $val)
            <div class="col-12 mt-5">
              <div class="card pb-3">
                <div class="card-body mt-0">
                  <a href="{{ route('whitepapers.url',[$val->url])}}" title="{{$val->title_tag}}" title="{{$val->title_tag}}">
