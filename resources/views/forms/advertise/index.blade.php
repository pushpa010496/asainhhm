          ...
          <div class="row mt-3">
            <div class="col-12">
              <div class="services-wrapper">
                ...
                <form  onsubmit="return validateForm()" action="{{route('advertise.post')}}" class="email" method="post"  id="writemessage">
...
@csrf
                    ...
                    <div class="input-group mb-3 mt-3">
                        <input type="text" class="form-control" name="designation" placeholder=" Job Title*" aria-label="Username" required>
                    </div>
                    <div class="input-group mb-3 mt-3">
                    ...
                    <div class="input-group mb-3 mt-3" >
                        <input type="phone" class="form-control" name="mobile" placeholder="Telephone Number*" aria-label="Username" required>
                    </div>
                    <div class="input-group mb-3 mt-3 arrow" style="position: !important;">
                      <!-- <select class="form-select mb-3"  id="service" name="service[]" aria-label=".form-select-lg example" required multiple >
                            <option value="Print Advertisement" style="color:#ddd3d6; !important">Print Advertisement</option>
                            <option value="Banner Advertisement" style="color:#ddd3d6; !important">Banner Advertisement</option>
                            <option value="E-Newsletter Sponsorship" style="color:#ddd3d6; !important">E-Newsletter Sponsorship</option>
                            <option value="Email Direct Marketing" style="color:#ddd3d6; !important">Email Direct Marketing</option>
                            <option value="Content Syndication – Lead Generation" style="color:#ddd3d6; !important">Content Syndication – Lead Generation</option>
                            <option value="Microsite – Lead Generation" style="color:#ddd3d6; !important">Microsite – Lead Generation</option>
                            <option value="Webinars" style="color:#ddd3d6; !important">Webinars</option>
                            <option value="Survey & Assessment Program" style="color:#ddd3d6; !important">Survey & Assessment Program</option>
                            <option value="Content Creation" style="color:#ddd3d6; !important">Content Creation</option>
                            <option value="Advertorial" style="color:#ddd3d6; !important">Advertorial</option>
                      </select> -->
                      <div id="myMultiselect" class="multiselect">

<div id="mySelectLabel" class="selectBox" onclick="toggleCheckboxArea()">

  <select class="form-select arrow" style='color: #a9a9a9 !important;' name="service[]" >
...
<label for="Email Direct Marketing"><input type="checkbox" id="ten" onchange="checkboxStatusChange()" value="Email Direct Marketing" /> Email Direct Marketing</label>
          ...
          <div class="row mt-4rem">
            <div class="col-12">
              <h2>Our Clients</h2>
              <div class="clients">
                <img data-src="https://industry.asianhhm.com//advertising/csc-logo.png" class="client-logo lazy" alt="clients-logo">
                <img data-src="https://industry.asianhhm.com//advertising/perkinelmer-logo.png" class="client-logo lazy" alt="clients-logo">
                <img data-src="https://industry.asianhhm.com//advertising/zebra-logo.png" class="client-logo lazy" alt="clients-logo">
                <img data-src="https://industry.asianhhm.com//advertising/orion-health-logo.png" class="client-logo lazy" alt="clients-logo">
                <img data-src="https://industry.asianhhm.com//advertising/abbott-logo.png" class="client-logo lazy" alt="clients-logo">
                <img data-src="https://industry.asianhhm.com//advertising/siemens-logo.jpg" class="client-logo lazy" alt="clients-logo">
                <img data-src="https://industry.asianhhm.com//advertising/roche-logo.jpg" class="client-logo lazy" alt="clients-logo">
                <img data-src="https://industry.asianhhm.com//advertising/ge-healthcare-logo.jpg" class="client-logo lazy" alt="clients-logo">
                <img data-src="https://industry.asianhhm.com//advertising/philips-logo.jpg" class="client-logo lazy" alt="clients-logo">
                <img data-src="https://industry.asianhhm.com//advertising/microsoft-logo.jpg" class="client-logo lazy" alt="clients-logo">
                <img data-src="https://industry.asianhhm.com//advertising/napier-logo.jpg" class="client-logo lazy" alt="clients-logo">
                <img data-src="https://industry.asianhhm.com//advertisers/1539600066-img-ascom-logo.jpg" class="client-logo lazy" alt="clients-logo">
                <img data-src="https://industry.asianhhm.com//advertisers/1488532104-img-ibm.jpg" class="client-logo lazy" alt="clients-logo">
                <a href="{{url('clients')}}">More...</a>
              </div>
            </div>
          </div>
...
function checkboxStatusChange() {
  ...
  var dropdownValue = "Select Service";
  if (values.length > 0) {
