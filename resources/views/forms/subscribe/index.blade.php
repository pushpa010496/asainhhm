	...
	<div class="border mt-4 mb-4 p-4">
		...
		<div class="row">
			...
			<div class="col-lg-8 col-md-8 col-sm-8 col-12">	
				...
				<h1 class="mb-4 PF-TXTRED mt-0">To subscribe Asian hospital and healthcare management please fill the form below :</h1>
				...
				<div class="mb-2">
					...
					<div class="custom-control custom-radio custom-control-inline mb-2">
						...
						<label class="custom-control-label" for="Radio-ebook">
							...
							<span class="font-16">I would like a free subscription to the <strong>Digital Version</strong></span>
					...
					<div class="custom-control custom-radio custom-control-inline mb-2">
						...
						<label class="custom-control-label" for="Radio-Magazine">
							...
							<span class="font-16">I would like a paid subscription to the <strong>Print Version</strong></span> 
					...
					<div class="custom-control custom-radio custom-control-inline mb-2">
						...
						<label class="custom-control-label" for="Radio-Mailing">
							...
							<span class="font-16">I would like a update my <strong>Mailing Address</strong></span>
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-12 ebook">	
				...
				<img src="{{config('app.url')}}images/e-magazine-devices-new-2.jpg" alt="Digital Version" class="img-fluid">
			...
			<div class="col-lg-3 col-md-3 col-sm-4 col-12 mag">
				...
				<img src="{{config('app.url')}}images/3-magazine.png" alt="Print Version" class="img-fluid">
			...
			<div class="col-lg-3 col-md-3 col-sm-4 col-12 mailing">
				...
				<img src="{{config('app.url')}}images/mailing-address.png" alt="Mmailing Address" class="img-fluid">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p style="color:green;"> Your subscribtion for Asian hospital and healthcare management has been succesfully completed.</p>
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-success" role="button" id="aa" name="aa"
                        ...
                        href="{{url('/subscribe')}}" aria-expanded="false">
		...
		<div class="ebook">
			...
			<form action="{{url('magazine-subscribe-post')}}" method="Post" enctype="multipart/form-data">
				...
				<div class="form-group form-custom">
					...
					<p>Your copy of the Asian hospital and healthcare management contains advertisements by the industry's leading companies. If you wish to receive more information from these companies about their products & services, simply tick the categories that interest you and return by fax to +91 40 4961 4555</p>
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								<div class="custom-control custom-checkbox">
									...
									<input type="checkbox" name="interest[]" class="custom-control-input" id="healthcare_management" value="Healthcare Management">
								...
								<div class="custom-control custom-checkbox">
									...
									<input type="checkbox" name="interest[]" value="Medical Sciences" class="custom-control-input" id="medical_sciences">
								...
								<div class="custom-control custom-checkbox">
									...
									<input type="checkbox" name="interest[]" value="Surgical Speciality" class="custom-control-input" id="surgical_speciality">
								...
								<div class="custom-control custom-checkbox">
									...
									<input type="checkbox" name="interest[]" value="Facility & Operations Management" class="custom-control-input" id="F_O">

									<label class="custom-control-label" for="F_O">Facility & Operations Management</label>

								</div>	  

								<div class="custom-control custom-checkbox">

									<input type="checkbox" name="interest[]" value="Information Technology" class="custom-control-input" id="I_T">
								...
								<div class="custom-control custom-checkbox">
									...
									<input type="checkbox" name="interest[]" value="Technology,Equipment & Devices" class="custom-control-input" id="T_E_D">

									<label class="custom-control-label" for="T_E_D">Technology, Equipment & Devices</label>

								</div>	

								<div class="custom-control custom-checkbox">

									<input type="checkbox" name="interest[]" value="Advertorials" class="custom-control-input" id="advertorials">

									<label class="custom-control-label" for="advertorials">Advertorials</label>
						...
						<div class="col-md-12 pt-2">
							...
							<div class="form-group">
								...
								<div class="custom-control custom-checkbox">
									...
									<input type="checkbox" name="accept[]" value="newsletter" class="custom-control-input" id="newsletter">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								<div class="custom-control custom-checkbox">
									...
									<input type="checkbox" name="int[]" class="custom-control-input" id="healthcare_management1" value="Healthcare Management">
								...
								<div class="custom-control custom-checkbox">
									...
									<input type="checkbox" name="int[]" value="Medical Sciences" class="custom-control-input" id="medical_sciences1">
								...
								<div class="custom-control custom-checkbox">
									...
									<input type="checkbox" name="int[]" value="Surgical Speciality" class="custom-control-input" id="surgical_speciality1">
								...
								<div class="custom-control custom-checkbox">
									...
									<input type="checkbox" name="int[]" value="Diagnostics" class="custom-control-input" id="diagnostics1">
								...
								<div class="custom-control custom-checkbox">
									...
									<input type="checkbox" name="int[]" value="Facility & Operations Management" class="custom-control-input" id="F_O1">

									<label class="custom-control-label" for="F_O1">Facility & Operations Management</label>

								</div>	  

								<div class="custom-control custom-checkbox">

									<input type="checkbox" name="int[]" value="Information Technology" class="custom-control-input" id="I_T1">

									<label class="custom-control-label" for="I_T1">Information Technology</label>

								</div>	

								<div class="custom-control custom-checkbox">

									<input type="checkbox" name="int[]" value="Technology,Equipment & Devices" class="custom-control-input" id="T_E_D1">

									<label class="custom-control-label" for="T_E_D1">Technology, Equipment & Devices</label>

								</div>	

								<div class="custom-control custom-checkbox">

									<input type="checkbox" name="int[]" value="Advertorials" class="custom-control-input" id="advertorials1">

									<label class="custom-control-label" for="advertorials1">Advertorials</label>
						...
						<div class="col-md-12 pt-2">
							...
							<div class="form-group">
								...
								<div class="custom-control custom-checkbox">
									...
									<input type="checkbox" name="acceptt[]" value="newsletter1" class="custom-control-input" id="newsletter1">
