        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 pt-3 pb-3" align="center">
          ...
          <a href="{{url('latest-ebook')}}" target="_blank">
            ...
            <div id="block" class="p-3 teal-blue-block transition">
              ...
              <span class="text-center PF-TXTBlk">{{trans('messages.siteshortname')}} latest E-book provides systematic approaches to enhance quality healthcare detailing the recent technologies.</span>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 pt-3 pb-3" align="center">
          ...
          <a href="{{url('editorial-calendar')}}" target="_blank">
            ...
            <div id="block" class="p-3 green1-block transition">
              ...
              <span class="text-center PF-TXTBlk">Our editorial calendar provides focused coverage of {{trans('messages.siteshortname')}} Issues covering emerging trends in the healthcare industry. </span>
