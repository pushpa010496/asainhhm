                  ...
                  <div class="col-lg-10 offset-lg-1"> 
                    ...
                    <h1 class="text-center form-title pt-3">E-NEWSLETTER SUBSCRIBE FORM</h1>
                      ...
                      @if(Session('status') == 'true') 
                        ...
                        <h3 style="color: green;" align="center"><em>We are grateful to you for your subscription to our e-Newsletter. A confirmation email shall be sent to you shortly. Your inbox will now be home to the latest healthcare news and updates.</em>
                    ...
                    <form action="{{route('newsletter.post')}}" method="post" name="vtiger_form" method="post" id="writemessage" class="form_count" accept-charset="utf-8" _lpchecked="1">        
                      ...
                      <div class="form-group col-lg-12">
                        ...
                        <div class="g-recaptcha" data-sitekey="6LdgRS8UAAAAAI2w6gepgumVmrg3op7kSl_67MaG">

                          <div style="width: 304px; height: 78px;">

                            <div>

                              <iframe src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6LdgRS8UAAAAAI2w6gepgumVmrg3op7kSl_67MaG&amp;co=aHR0cHM6Ly93d3cuYXNpYW5oaG0uY29tOjQ0Mw..&amp;hl=en&amp;v=v1545073489967&amp;size=normal&amp;cb=9daq5uigdto6" role="presentation" name="a-2t3zzprf2o5y" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox allow-storage-access-by-user-activation" width="304" height="78" frameborder="0"></iframe>
