...
<head>
	...
	<title>ASIAN HOSPITAL & HEALTHCARE MANAGEMENT</title>
	...
	<meta property="og:image" content="{{config('app.url')}}images/ahhm-mediapack-og.jpg" />
	...
	<style type="text/css">
		...
		.form-control{font-size: 14px; height: calc(2rem + 2px); background-color: #fcdde2; border: none;}
	...
	<!-- <div class="container">
		<div class="row">
			<div class="col-lg-3 col-md-3 col-sm-4 my-auto">
				<img src="{{config('app.url')}}images/logo.png" alt="Asian Hospital & Healthcare Management" class="img-fluid" width="200">
			</div>
			...
			<div class="col-lg-5 col-md-5 col-sm-12 col-12 offset-md-1 mt-4">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-12">
						...
						<p class="TXT-GRAY font-weight-bold">550K+</p>

						<h3 class="font-weight-bold font-20 mt-4 mb-0">UDMs Profile Breakdown</h3> 
						<p class="TXT-GRAY font-weight-bold font-weight-bold">C-Suites, President, VPs, Directors, Senior Executives, Middle Management, Research Staff</p>

						<h3 class="font-weight-bold font-20 mt-4 mb-0">Readership</h3> 
						<p class="TXT-GRAY font-weight-bold mb-0">Hard Copy Format - 87K</p>
						<p class="TXT-GRAY font-weight-bold">E-Book Format - 440K</p>

						<h3 class="font-weight-bold font-20 mt-4 mb-0">Global Reach  (% of subscribers)</h3> 
						<p class="TXT-GRAY font-weight-bold mb-0">Asia-Pacific - 45%</p>
						<p class="TXT-GRAY font-weight-bold mb-0">Europe - 30%</p>
						<p class="TXT-GRAY font-weight-bold mb-0">America - 15%</p>
						<p class="TXT-GRAY font-weight-bold">Rest of the World - 10%</p>
					</div> 
				</div>			
			</div>
			...
			<div class="col-lg-5 col-md-5 col-sm-12 col-12 mt-3 mb-4">
				<div class="border shadow p-2">
					...
					<form action="{{route('cmpmediapacks.post')}}" class="email" id="writemessage" method="post" accept-charset="utf-8">
						...
						<input type="hidden" name="name" value="asianhhm-advertise">
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-2 col-md-2 col-sm-4 col-6 mb-4 text-center">
				<img src="{{config('app.url')}}images/ibm-logo.jpg" alt="IBM" class="img-fluid border">
			</div>

			<div class="col-lg-2 col-md-2 col-sm-4 col-6 mb-4 text-center">
				<img src="{{config('app.url')}}images/orion-logo.jpg" alt="Orion Health" class="img-fluid border">
			</div>

			<div class="col-lg-2 col-md-2 col-sm-4 col-6 mb-4 text-center">
				<img src="{{config('app.url')}}images/roche-logo.jpg" alt="Roche" class="img-fluid border">
			</div>
			...
			<div class="col-lg-2 col-md-2 col-sm-4 col-6 mb-4 text-center">
				<img src="{{config('app.url')}}images/ups-logo.jpg" alt="UPS" class="img-fluid border">
			</div>

			<div class="col-lg-2 col-md-2 col-sm-4 col-6 mb-4 text-center">
				<img src="{{config('app.url')}}images/inter-systems-logo.jpg" alt="Inter Systems" class="img-fluid border">
			</div>

			<div class="col-lg-2 col-md-2 col-sm-4 col-6 mb-4 text-center">
				<img src="{{config('app.url')}}images/oracle-logo.jpg" alt="Oracle" class="img-fluid border">
			</div>

			<div class="col-lg-2 col-md-2 col-sm-4 col-6 mb-4 text-center">
				<img src="{{config('app.url')}}images/philips-logo.jpg" alt="Philips" class="img-fluid border">
			</div>

			<div class="col-lg-2 col-md-2 col-sm-4 col-6 mb-4 text-center">
				<img src="{{config('app.url')}}images/fuji-xerox-logo.jpg" alt="Fuji Xerox" class="img-fluid border">
			</div>

			<div class="col-lg-2 col-md-2 col-sm-4 col-6 mb-4 text-center">
				<img src="{{config('app.url')}}images/microsoft-logo.jpg" alt="Microsoft" class="img-fluid border">
			</div>

			<div class="col-lg-2 col-md-2 col-sm-4 col-6 mb-4 text-center">
				<img src="{{config('app.url')}}images/siemens-logo.jpg" alt="Siemens" class="img-fluid border">
			</div>

			<div class="col-lg-2 col-md-2 col-sm-4 col-6 mb-4 text-center">
				<img src="{{config('app.url')}}images/abbott-logo.jpg" alt="Abbott" class="img-fluid border">
			</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-4 col-sm-12 col-12">	          		
					<p><i class="fa fa-globe mr-1" aria-hidden="true"></i> www.asianhhm.com</p>
				</div>

				<div class="col-md-5 col-sm-12 col-12 text-center">	          		
					<p><i class="fa fa-envelope mr-1" aria-hidden="true"></i> advertise@asianhhm.com</p>
				</div>
