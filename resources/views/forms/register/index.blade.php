                  ...
                  <form action="{{route('registration.post')}}" method="post" name="vtiger_form" method="post" id="writemessage" class="form_count" accept-charset="utf-8" _lpchecked="1">        
                    ...
                    <div class="form-group col-lg-12">
                     ...
                     <div class="text-left form-group mb-0"> 
                      ...
                      <label class="checkbox-inline text-muted"> 
                        ...
                        <input type="checkbox" name="magazine_de" id="magazine_de" checked required=""> &nbsp; Yes, I would like to subscribe to Digital Magazine
                    ...
                    <div class="text-left form-group mb-0"> 
                      ...
                      <label class="checkbox-inline text-muted"> 
                        ...
                        <input type="checkbox" name="current_newsletter" id="current_newsletter" checked required=""> &nbsp; Yes, I would like to subscribe to e-Newsletter
