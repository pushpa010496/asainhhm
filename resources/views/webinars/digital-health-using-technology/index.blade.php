...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-lg-3 col-md-6 col-sm-4 my-auto">

			<img src="{{config('app.url')}}images/logo.png" alt="Asian HHM" class="img-fluid" width="200">

		</div>

		<div class="col-lg-4 col-md-6 col-sm-8 my-auto offset-lg-5 pt-2 text-right gray-text align-self-center">

			<p class="mb-0">

				<em class="mt-5"><span>Webinar Sponsored by</span></em>

				<img src="{{config('app.url')}}webinars/freshservice/iqvia-logo.jpg" alt="IQVIA" class="ml-2 img-fluid">
...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mt-2 text-center">
			...
			<img src="{{config('app.url')}}webinars/freshservice/iqvia-banner.jpg" alt="IQVIA" title="IQVIA" class="img-fluid shadow" />
		...
		<div class="col-lg-7 col-md-7 col-sm-12 col-12 person pt-3">
			...
			<h1 class="font-weight-bold PF-TXTRED font-18"><span class="blue-text">Digital Health: </span>Using technology to engage with patients </h1>



			<!-- <p class="mb-2">IQVIA helps you drive healthcare forward by creating intelligent connections with an expansive portfolio of capabilities and technologies, unparalleled data, and global healthcare expertise. </p>



			<p>Discover the evidence, research and analytics underway that is helping accelerates our understanding of how health systems function, how treatment is evolving, and how care is being delivered. </p>

			<p>We want to make a difference in healthcare. To get there it takes diverse skills and a curiosity to explore new possibilities. No matter your role, everyone at IQVIA contributes to our shared goal of improving human health. Find out how you can put your passions to work. </p> -->
		...
		<div class="col-lg-5 col-md-5 col-sm-12 col-12 mt-4 mb-4 align-self-center">
			...
			<img type="button" data-toggle="modal" data-target="#videoFormModal" src="{{config('app.url')}}webinars/freshservice/iqvia-ondemand.jpg" alt="IQVIA" title="IQVIA" class="img-fluid video shadow text-center border" />
			...
			<div class="p-2 PF-BrdrDDD mb-3 bg-white shadow">
				...
				<div class="row">
					...
					<div class="col-lg-2 col-md-2 col-sm-12 col-12 text-center">
						...
						<img src="{{config('app.url')}}webinars/freshservice/anurag-saxena.jpg" alt="IQVIA" class="img-fluid border">

					</div>

					<div class="col-lg-10 col-md-10 col-sm-12 col-12 align-self-center">

						<h2 class="mt-2 mb-2"><strong>Anurag Saxena </strong></h2>

						<p class="mb-2"><strong>Designation: </strong><em class="gray-text">Principal & Head - Digital Health Consulting and Solutions for Payers, Providers & Government (South Asia) </em></p>

						<p class="mb-2"><strong>Organization:  </strong><em class="gray-text">IQVIA, India </em></p>

						<p>Anurag is a Principal at IQVIA and leads teams in India and South Asia focusing on Digital Health Consulting as well as Products and Solutions for Payers, Providers and Government. He is spearheading some of the largest transformation projects in Digital Health in the region for IQVIA. He is also driving Digitization of Healthcare systems for some of the largest Providers in the region. Prior to joining IQVIA, he has worked with organisations like Ernst & Young, Deloitte, SAP, NEC Corporation and HCL Technologies in leadership roles. Anurag has been involved in some of the world's largest Digital Transformation projects in the areas of Digital Health, Digital Identity, Digital Government and Digital Payments in Advisory and Program Management roles. He has also advised several boardrooms for formulation and execution of Go-to-market strategy for Technology businesses in India and South Asia. </p>
	...
	<div class="modal-dialog modal-md">			
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form action="{{ url('digital-health-using-technology-to-engage-with-patients-success') }}" method="post" id='writemessage' >
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group {{ $errors->first('name', 'has-error')}}">
								...
								<input type="hidden" name="type" id="type" value="Digital Health On demand Webinar" />

								<input type="hidden" name="formtype"  value="modal-form" />

								<input type="hidden" name="thank_message" value="Thank you for your interest in Digital Health: Using technology to engage with patients On demand Webinar.">

								<input type="hidden" name="client_message" value="Thank you for your interest in Digital Health: Using technology to engage with patients On demand Webinar.">
