        ...
        <div class="row PF-WytBG">
            ...
            <div class="col-lg-9 col-md-9 col-sm-9 col-12 PF-BrdrDDD p-1">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-12 pb-2">
                ...
                <p>This section covers the managerial aspects in the Healthcare industry.</p>
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-12 title-list">
               ...
               {{--  <p class="PF-TXTBlk pt-1">{{$val->home_description}}</p>   --}}      
                ...
                <p class="mb-0">{{ \Illuminate\Support\Str::limit(preg_replace('/[^a-zA-Z\s]/', '', strip_tags(html_entity_decode(ucfirst($val->short_description)))),$limit = 250, $end = '...') }} </p>    
...
<script type="text/javascript">
 ...
 var url = "{{ url('viewnewswires/month').'/'.$month .'/year/'.$year}}";
