          ...
          <nav aria-label="breadcrumb">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item">
                   ...
                   <a href="">e-Newsletter Archives</a>
            ...
            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 PF-BrdrDDD p-1">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pt-2">
                ...
                <div class="PF-BrdrBEEE col-lg-12 col-md-12 col-sm-12 col-xs-12 p-0 mb-3">
                  ...
                  <h1 class="float-left PF-Bshelf">e-Newsletter Archives</h1>

                  <span class="PF-ForthIssue PF-MobP015 PF-MobMB10">

                    <a href="{{config('app.url')}}e-newsletters/{{$data[0]->file}}" target="_blank" class="float-right">

                      <i class="fa fa-book mr-2"></i> LATEST ISSUE</a>
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-12"> <!--// Events Content -->
                ...
                <div class="row">
                  ...
                  <div class="col-lg-3 col-md-3 col-sm-4 col-12">
                    ...
                    <a href="{{config('app.url')}}e-newsletters/{{$val->file}}" target="_blank" class="">

                      <span class="PF-NwsLtr">

                        <img src="{{config('app.url')}}e-newsletters/images/vertical-cover-logo-enews.jpg" alt="{{$val->title}}" width="100%" />
