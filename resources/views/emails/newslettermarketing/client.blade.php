...
<table width="800" border="0" align="left" cellpadding="10">
  ...
  <tr>
    <td>
      ...
      <tr>
        <td align="left" valign="middle" style="font-family: 'Roboto', sans-serif;font-size:13px;">Greetings from Asian Hospital Healthcare Management!</td>
      </tr>
      <tr>
        <td align="left" valign="middle" style="font-family: 'Roboto', sans-serif;font-size:13px;">Thank you for your initiative of E-Newsletter Marketing through our magazine. Our team will earnestly study your requirements and get in touch with you shortly.</td>
      </tr>
   ...
   <tr>
    ...
    <img src="{{ config('app.url') }}images/logo.png" alt="{{trans('messages.sitename')}}" width="300"/>    </td>
  </tr>
  <tr>
