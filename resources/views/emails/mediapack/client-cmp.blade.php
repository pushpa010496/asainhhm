  ...
  <tr>
    <td>
      <table width="800" border="0" cellpadding="5">
          ...
          <tr>
            <td align="left" valign="middle" style="font-family: 'Roboto', sans-serif;font-size:13px;">Your Media Pack  download request was successful. Please find the link to download the same below.If you have any trouble downloading the Media Pack, kindly get in touch with us at advertise@asianhhm.com
           </td>
            </tr>
