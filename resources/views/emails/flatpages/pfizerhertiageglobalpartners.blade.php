      ...
      <table width="800" border="0" cellpadding="5">
          <tr>
            <td align="left" valign="middle" style="font-family: 'Roboto', sans-serif;font-size:13px; line-height:20px">
              ...
              You have successfully submitted enquiry for <strong> {{ $client_message }}</strong>, One of the pfizer auction team member will get back to you.
              <br><br>
              Happy Surfing.
          <tr>
            <td>&nbsp;</td>
          </tr>           
              <span class="pt-3">Sincerely,</span>
              <br> <span> Client Success Team (CRM),</span>
             </td>
            </tr>  
            <tr>
