              ...
              <table width="800" border="0" cellpadding="5">
                <tr>
                  <td align="left" valign="middle" style="font-family: 'Roboto', sans-serif;font-size:13px; line-height:20px">
                    ...
                    Thank you for downloading AI in Healthcare WhitePaper. <br>

                    <a href="{{asset('public/pdf/AI_Healthcare_Pure_Storage_SPRING_2019.pdf')}}">Click here to download Whitepaper</a>
                    <br><br /> 
                    Thank you!<br /> 
                  </td>
                </tr>
