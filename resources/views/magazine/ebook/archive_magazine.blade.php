...
@section('content')
   ...
   <div class="container-fluid breadcrumb-live">
      <div class="row">
        <div class="col-12"><a href=""> </a>
            <div class="ahhm-breadcrumb">
              <a href="{{url('magazine')}}" class="ahhm-breadcrumb-item">{{trans('messages.archives-magazine_title')}}</a>
...
<div class="col-12 col-lg-12 ahhm-ebook-archives">
  ...
  <div class="row">
    ...
    <div class="col-12">
      ...
      <h1 class="mt-0">Previous Issue - {{ ucfirst($ebook->issue->issue_no)}}</h1>
      ...
      <div class="current-issue">
        ...
        <div class="row m-0">
            ...
            <div class="current-issue-stamp">
                ...
                <h1 style="text-transform: uppercase;">{{ ucfirst($ebook->issue->issue_no)}}</h1>
