...
<div class="text-center mt-5">
    <h1  class="text-white" style="font-size:38px !important;" >PLEASE LOGIN TO ACCESS MAGAZINE ARTICLES<br> (OR) <br>E-BOOK</h1> 
</div>
</div>
...
<form action="{{route('login.post')}}" method="post" id="form-validation">
                            ...
                            <h3 class="text-center" style="font-size:18px;">Access Latest E-Book / Magazine Articles</h3>
                               ...
                               @if(session('latestarticle'))
             <input type="hidden" name="previous_url" value="https://www.asianhhm.com/{{session('category')}}/{{session('url')}}">
            @elseif(session('statusebook'))
                <input type="hidden" name="previous_url" value="https://www.asianhhm.com/{{session('url')}}/{{session('ebookid')}}">
                <input type="hidden" name="ebookid" value="{{session('ebookid')}}">
             @elseif(session('latestebook'))
                <input type="hidden" name="previous_url" value="https://www.asianhhm.com/{{session('url')}}">
            @else
            ...
            @endif
                                        ...
                                        <div class="input-group mb-3 mt-3  ">
                                            <select required="" class="form-control arrow" id="country" name="country"
