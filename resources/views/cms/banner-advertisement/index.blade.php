  ...
  <div class="container-fluid hero-header">
    ...
    <div class="row MRGN-TOP-80">
      <div class="container pb-2">
          ...
          <p class="PF-TXTBlk000">Banner Advertising accelerates your brand presence and empowers business with tailor-made solutions. AHHM Healthcare banner advertising leverages your online presence and maximizes traffic besides enhancing business brand value.</p> 

          <h2 class="TXT-blu"><em>Be transparent in your business and boost brand awareness through AHHM Banner Advertising Services!</em></h2>     
      </div>  
      ...
      <div class="visitors row">
        <div class="col-md-4 pt-4 pb-4">
          <div class="content-ct rate text-center">
            ...
            <p class="mt-2 TXT-yellow font-30">650,000+</p>
          </div>
        </div>
        ...
        <div class="col-md-4 pt-4 pb-4">
          <div class="content-ct rate text-center">
            ...
            <p class="m-0"><em>per month</em></p>
            <p class="mt-2 TXT-yellow font-30">60,000+</p>
          </div>
        </div>	
        ...
        <div class="col-md-4 pt-4 pb-4">
          <div class="content-ct rate text-center">
            ...
            <p class="m-0 TXT-yellow font-30">700+</p>
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pt-3" align="center">  
        <table border="0" cellpadding="1" cellspacing="1" style="width:100%" align="center" class="mt-1">
          ...
          <tbody>
            <tr>
              <td colspan="2">
                <img width="100%" src="{{config('app.url')}}images/ahhm-geographical-breakdown.jpg" class="img-responsive" alt="Geographical"/>
              </td>
            </tr>             
          </tbody>
        </table>
