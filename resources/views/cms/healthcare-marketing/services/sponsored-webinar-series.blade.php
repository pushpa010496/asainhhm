            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content" style="background-color:#fff !important;">
                    ...
                    <div class="modal-footer">
                        ...
                        <a class="btn btn-primary" role="button" id="aa" name="aa" href="{{url('healthcare-marketing/services/sponsored-webinar-series')}}"
    ...
    <div class="container-fluid p-0 m-0">       
      <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-12 p-0 m-0">
                <div class="p-0 m-0">
                  <img class="p-0 m-0" src="https://industry.asianhhm.com/promotions/images/sponsored-webinar-series-prime-banner.jpg" alt="print-advertising-main-banner" width="100%">
                </div>
            </div>
      </div>
</div>
...
<div class="container-fluid mt-5">
  <div class="row">
    <div class="col-md-12 col-12">
      ...
      <h1 class="font-40" style="font-family:Montserrat, sans-serif;">B2B Webinar Series </h1>
      <p class="pt-2 mb-3" style="font-family:Montserrat, sans-serif;font-size:21px;">(Industrial Virtual Event) – Multifaceted Coverage, In-depth Engagement, Brand Authority & Insightful</p>
...
<div class="container-fluid mt-1">
  <div class="row">
    ...
    <div class="mt-5 text-center content-style">
                      ...
                      AsianHHM's expertise in planning, marketing and hosting webinar series for its clients brings comprehensive exploration of topics, fostering deeper engagement, progressive learning, and market insights for your diverse set of audiences. We help you to establish thought leadership, nurture leads, while planning to propel maximum attendance and engagement with your target audience. Bolstered with our extensive consulting prowess webinar series helps you in attaining measurable impact and efficient resource utilization in a cost-effective way.
                      </p>
                      <p class="mb-3" style="font-family:Montserrat, sans-serif;font-size:16px;line-height:26px;">
                      We excel in ideation, planning, hosting, marketing, and data analytics. B2B Webinar Series provide a potent chance to connect with your target audience at a deeper level, yielding highly engaged premium leads and offer invaluable real-time analytics and attendee data.
                      </p>
...
<div class="container-fluid mt-5">
  <div class="row">
    ...
    <div class="row">     
        ...
        <div>
          <img src="https://industry.asianhhm.com/promotions/images/webinar-metrics2.png" alt="webinar-sponserad" >
        </div>
        </div>
        <!-- <div class="col-md-3 col-12 " >
        <div>
          <img src="https://industry.asianhhm.com/promotions/images/webinar-sponserad.png" alt="webinar-sponserad" width="100%" height="200">
        </div>
        </div>  
        <div class="col-md-3 col-12 " >
        <div>
...
<h2 class="mt-5 mb-3" style="font-family:Montserrat, sans-serif;">Webinar Series Audience Metrics</h2></div>
...
<ul class="li-style">
<li>Branded Microsite</li>
<li>Live Polling & Metrics</li>
<li>Live-Long Hosting on our website</li>
<li>Detailed Analytics & Engagement Reporting</li>
<li>Event Moderation</li>
<li>Live Q&A</li>
<li>Professional Networking Programs</li>
<li>One-2-One Audience Interaction Capability</li>
<li>Event Marketing
<ul class="li-style">
<li>Email Marketing</li>
<li>Social Media Promotions </li>
<li>Display Advertising Promotions</li>
<li>Registrations & Retention Reminders</li>
...
<div>
<img src="https://industry.asianhhm.com/promotions/images/webinar-series.jpg" alt="sponserad-webinar-series" width="100%" height="480">
</div>
...
<a href="https://www.asianhhm.com/healthcare-marketing/services/webinars" class="btn-Sponsored" style="color:#fff;font-size:20px;">Webinars</a>
</div>                                    
</div>
</div>  
</div>
...
<div class="container-fluid mt-5">
  <div class="row">
    ...
    <div class="content-style">
      <div class="text-center">
    <h2 class="mt-5 mb-3 text-center" align="center" style="font-family:Montserrat, sans-serif;">Webinar Series Packages</h2>
    </div>
    <div class="row">     
        <div class="col-md-4 col-12" >
        <div>
        <h2 class="mt-5 mb-3" style="font-family:Montserrat, sans-serif;">Webinar Series Beginner</h2>
          <ul class="li-style">
            <li>Branded Registration Microsite</li>
            <li>Social Media Marketing</li>
            <li>Email Marketing (5K IAPs*)</li>
             <li>Newsletter inclusion – Display Advertising</li> 
             <li>350+ live registrations</li>
             <li>Life-Long Hosting of Microsite with On-Demand Webinar Video Lead Generation.</li>              
          </ul>
          ...
          <div class="">&nbsp;</div>
                    <a data-toggle="modal" data-target="#registerform"class="mb-3"><h4 class="text-center btn-style" style="border:2px solid #ed1a3b;font-family:Montserrat, sans-serif;background-color:#ed1a3b;color:#fff;padding:10px;border-radius:3px;width:100%;max-width:100%;font-weight:bold;
    font-size: 16px;">Learn More </h4></a>
        </div>
        </div>
        <div class="col-md-4 col-12" >
        <div>
        <h2 class="mt-5 mb-3" style="font-family:Montserrat, sans-serif;">Webinar Series Plus <br><span style="font-size:14px;text-transform: capitalize;"> <small><i>( Recommended )</i></small></span></h2>
        <ul class="li-style">
            <li>Branded Registration Microsite</li>
            <li>Multi-Lingual Content Generation & Promotions</li>
            <li>Multi-Lingual , Multi-Channel Social Media Marketing</li>
             <li>Banner Advertising</li> 
             <li>Email Marketing (25K IAPs*)</li>
             <li>Multiple Newsletter inclusion – Display Advertising</li>
    ...
    font-size: 16px;">Learn More </h4></a>
        ...
        <div class="col-md-4 col-12" >
        <div>
        <h2 class="mt-5 mb-3" style="font-family:Montserrat, sans-serif;">Webinar Series NexGen</h2>
        <ul class="li-style">
            <li>Branded Registration Microsite</li>
            <li>Multi-Lingual Content Generation & Promotions</li>
            <li>Multi-Lingual , Multi-Channel Social Media Marketing</li>
             <li>Banner Advertisingg</li> 
             <li>Email Marketing (45K IAPs*)</li>
             <li>Multiple Newsletter inclusion – Display Advertising</li>
              <li>800+ live registrations</li>
              <li>Life-Long Hosting of Microsite with On-Demand Webinar Video Lead Generation.</li>
          </ul>
          <small><i><b>*IAP – Ideal audience profiles</b></i></small>
...
<div class="container-fluid mt-5 mb-5">
    ...
    <h1 class="font-40" style="font-family:Montserrat, sans-serif;">Clientele</h1>
    </div>
    <div class="row">
...
<!-- 6th container end -->
  ...
  <div id="registerform" class="modal fade show" role="dialog" style="padding-right: 17px;">
      ...
      <div class="modal-content" style="padding:1% 5%;">
              ...
              <div class="modal-body">
              <form action="{{ route('sponsoredWebinarSeries.post') }}" method="post" id="writemessage">
                 @csrf
                     ...
                     <input type="hidden" name="g-recaptcha-response" id="g-recaptcha-response" >
                      ...
                      <input type="hidden" name="admin_subject" value="Book free consultation – sponsored-webinar-series – Asianhhm">
