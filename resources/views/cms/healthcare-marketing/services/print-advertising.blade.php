            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content" style="background-color:#fff !important;">
                    ...
                    <div class="modal-footer">
                        ...
                        <a class="btn btn-primary" role="button" id="aa" name="aa" href="{{url('healthcare-marketing/services/b2b-print-advertising')}}"
    ...
    <div class="container-fluid ">       
      <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-12 p-0 m-0">
                <div class="p-0 m-0">
                  <img class="p-0 m-0" src="https://industry.asianhhm.com/promotions/images/print-advertising-main-banner.jpg" alt="print-advertising-main-banner" width="100%">
                </div>
            </div>
      </div>
</div>
...
<div class="container-fluid mt-5">
  <div class="row">
    <div class="col-md-12 col-12">
      ...
      <h1 class="font-40" style="font-family:Montserrat, sans-serif;">Print Media Advertising</h1>
...
<!-- 6th container end -->
  ...
  <div id="registerform" class="modal fade show" role="dialog" style="padding-right: 17px;">
      ...
      <div class="modal-content" style="padding:1% 5%;">
              ...
              <div class="modal-body">
              <form action="{{ route('printadvertising.post') }}" method="post" id="writemessage">
                 @csrf
                 <input type="hidden" name="_token" value="{{ csrf_token() }}">		
                     ...
                     <input type="hidden" name="g-recaptcha-response" id="g-recaptcha-response">
                      ...
                      <input type="hidden" name="admin_subject" value="Book free consultation – b2b-print-advertising – Asianhhm">
