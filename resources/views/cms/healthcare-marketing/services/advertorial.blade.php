            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content" style="background-color:#fff !important;">
                    ...
                    <div class="modal-footer">
                        ...
                        <a class="btn btn-primary" role="button" id="aa" name="aa" href="{{url('healthcare-marketing/services/b2b-print-advertorial')}}"
...
<div class="container-fluid mt-5">
  <div class="row">
    <div class="col-md-12 col-12">
      ...
      <h1 class="font-40" style="font-family:Montserrat, sans-serif;">B2B Print Advertorials </h1>
      <p class="pt-2 mb-3" style="font-family:Montserrat, sans-serif;font-size:21px;"> Build Brand Awareness</p>
           </div>
    </div>
  </div>
</div>
...
<div class="container-fluid mt-5">
  <div class="row">
    <div class="col-md-12 col-12">
      ...
      AsianHHM's Advertorial marketing can be an effective way to engage audiences, 
      tell compelling brand stories, and achieve marketing objectives. Our team 
      assits clients with careful planning, creativity, and adherence to ethical 
      practices to achieve their optimal marketing results. 
      </p>
      <p class="mt-2" style="font-family:Montserrat, sans-serif;font-size:16px;">
          Also known as native advertising, AsianHHM team helps clients in formulating 
          their marketing strategy that combines elements of both advertising and 
          editorial content. It involves creating content that looks and feels like 
          regular editorial content within a publication or platform while promoting 
...
<div class="container-fluid mt-5">
  <div class="row">
    <div class="col-md-12 col-12">
            <div class="text-center content-style">
                        <h2 class="mt-5" style="font-family:Montserrat, sans-serif;">B2B Print Advertorials for Enhanced Brand Awareness? <br>
                <!-- <p class="mt-3">&amp; expertise in B2B Marketing.</p> -->
              </h2>
                      <p class="mt-3" style="font-family:Montserrat, sans-serif;font-size:26px;">AsianHHM Delivers Expected Branding 
     <br>Objectives through Advertorial Promotions resulting to MQLs
                        </p>    
            <br>
...
<!-- 4rd container End -->
  ...
  <div id="registerform" class="modal fade show" role="dialog" style="padding-right: 17px;">
      ...
      <div class="modal-content" style="padding:1% 5%;">
              ...
              <div class="modal-body">
              <form action="{{ route('advertorial.post') }}" method="post" id="writemessage">
                 @csrf
                    ...
                    <input type="hidden" name="g-recaptcha-response" id="g-recaptcha-response">
                      ...
                      <input type="hidden" name="admin_subject" value="Book free consultation –b2b-print-advertorial– Asianhhm">
