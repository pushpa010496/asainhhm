            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content" style="background-color:#fff !important;">
                    ...
                    <div class="modal-body">
                        ...
                        <p style="color: green;">Your Registration was Successful</p>
						<br>   
                    </div>

                    <div class="modal-footer">

                        <a class="btn btn-primary bg-primary" role="button" id="aa" name="aa" href="{{url('healthcare-marketing/services/b2b-email-marketing')}}"
...
<div class="text-center content-style">
    <h1 class="font-40" style="font-family:Montserrat, sans-serif;">Email Marketing</h1>
    <br>
    <h1 class="pt-0 mt-0"  style="font-family:Montserrat, sans-serif;font-size:32px;">B2B Email Marketing – Improve your Strategic Reach</h1>
    <p class="pt-2 mb-2" style="font-family:Montserrat, sans-serif;font-size:22px;">  B2B Email Marketing for Brand Awareness and Lead Generation
    </p>
</div>
</div>
</div>
...
<div class="mt-5 text-center content-style">
    ...
    <p class="mb-3 mt-3" style="font-family:Montserrat, sans-serif;font-size:16px;line-height:26px;">
        In B2B email marketing, AsianHHM help companies create and send tailored emails
        that address the specific needs and pain points of their target audience. These 
        emails can include promotional offers, educational content, industry news, 
        product updates, and other relevant information that adds value to the recipient.
        By leveraging AsianHHM's B2B email marketing program, businesses can generate leads,
        drive conversions, and foster long-term customer loyalty. We provide cost-effective
        and measurable marketing approach that allows our clients to track open rates, 
        click-through rates, and other important metrics to optimize their campaigns for better results.
...
<div class="col-md-12 col-12">
<div class=" text-center content-style">
    <p class="mb-4 mt-3" style="font-family:Montserrat, sans-serif;font-size:21px;">Create Optimised Lead Magnets through,
        <br> 
        Asian Hospital & Healthcare Management (AHHM) Email Marketing Program.
        </p>
    
    <h2 class="mb-5" style="font-family:Montserrat, sans-serif;font-size:23px;">We Assure Optimal ROI on your Email Marketing Spend</h2>
    <br>
...
<div class="mt-1"> 
<img src="https://industry.asianhhm.com/promotions/images/webinar-global-img.jpg" alt="webinar-global-img" width="100%" height="340px">
</div>
</div>
...
<div class="  text-center content-style">
    ...
    <h2 class="mb-3 mt-5" style="font-family:Montserrat, sans-serif;font-size:24px;">Reliable & Affordable means to reach you Target Audience</h2>
    <p class="mb-5 mt-3" style="font-family:Montserrat, sans-serif;font-size:22px;">Asian Hospital & Healthcare Management’s (AsianHHM)  
    <br>
    B2B Email Marketing
    </p>
...
<div class="btn-blink" style="width:100%;padding:13px 50px;text-align:center;background-color:#ed1a3b;color:#fff;border-radius:3px;">
    <a href="https://www.asianhhm.com/healthcare-marketing/services/outbound-email-marketing" class="btn-Sponsored" style="color:#fff;font-size:20px;">Outbound Email Marketing</a>
</div>                                    
</div>
</div>
<div class="col-md-6 col-12">
...
<div>
  ...
  <div id="registerform" class="modal fade show" role="dialog" style="padding-right: 17px;">
      ...
      <div class="modal-content" style="padding:1% 5%;">
              ...
              <div class="modal-body">
              <form action="{{ route('marketing.post') }}" method="post" id="writemessage">
                 @csrf
                 <input type="hidden" name="_token" value="{{ csrf_token() }}">		
                        <input type="hidden" name="formtype" value="modal-form">
                      <input type="hidden" name="type" value="b2b-email-marketing">
                      <input type="hidden" name="client_subject" value="Thank you – Book free consultation - Asianhhm">
                      <input type="hidden" name="admin_subject" value="Book free consultation – b2b-email-marketing – Asianhhm">
