            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content" style="background-color:#fff !important;">
                    ...
                    <div class="modal-footer">
                        ...
                        <a class="btn btn-primary bg-primary" role="button" id="aa" name="aa" href="{{url('healthcare-marketing/services/newsletter-sponsorship')}}"
...
<div class="text-center content-style">
    <h1 class="font-40" style="font-family:Montserrat, sans-serif;">Newsletter Sponsorship</h1>
    <p class="pt-2 mb-3" style="font-family:Montserrat, sans-serif;font-size:21px;">High Impact Exclusive Business Newsletter - 
        Significant tool in your B2B Email Advertising
        </p>
</div>
</div>
</div>
...
<div class="mt-5 text-center content-style">
    ...
    <p class="mb-3 mt-3" style="font-family:Montserrat, sans-serif;font-size:16px;line-height:26px;">
        Our weekly newsletter is a curated collection of exclusive and 
    high-quality content delivered to our subscribers regularly. 
    It covers the latest industry updates and offers valuable insights,
    reaching an impressive audience of over 180,000 business contacts.
    If you are seeking to enhance your brand equity, expand market presence,
    or execute successful product launches, AsianHHM's Newsletter Advertising and
    Sponsorship opportunities provide an ideal solution. With greater 
    campaign control and measurable results, this option ensures an 
    effective and impactful advertising strategy for your brand.
...
<div class="col-md-12 col-12">
<div class=" text-center content-style">
<p class="mb-4 mt-3" style="font-family:Montserrat, sans-serif;font-size:22px;">Targeted and Measurable Newsletter Advertising with
<br> 
Asian Hospital & Healthcare Management (AHHM)
</p>
<h2 class="mb-5" style="font-family:Montserrat, sans-serif;font-size:24px;">Take the Guesswork Out of Your Audience Targeting</h2>
<br>
...
<ul class="li-style">
    ...
    <li>Newsletter Sponsoring & Ad- space services available.</li>
...
<div class="mt-1"> 
<img src="https://industry.asianhhm.com/promotions/images/webinar-global-img.jpg" alt="webinar-global-img" width="100%" height="310px">
</div>
</div>
...
<div class="  text-center content-style">
    ...
    <p class="mb-5 mt-3" style="font-family:Montserrat, sans-serif;font-size:22px;">Asian Hospital & Healthcare Management (AsianHHM) 
    <br>
...
<div id="registerform" class="modal fade show" role="dialog" style="padding-right: 17px;">
    ...
    <div class="modal-content" style="padding:1% 5%;">
            ...
            <div class="modal-body">
            <form action="{{ route('newsletterSponsorship.post') }}" method="post" id="writemessage">
               @csrf
                    ...
                    <input type="hidden" name="admin_subject" value="Book free consultation – newsletter-sponsorship – Asianhhm">
