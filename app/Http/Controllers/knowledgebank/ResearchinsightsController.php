...
class ResearchinsightsController extends HomeController
{
	...
	{	
		$researchinsights = ReaserchInsites::where('url',$url)->where('active_flag',1)->orderBy('id','desc')->select('description','title','id','author_details','short_description','created_at','updated_at')->first();
