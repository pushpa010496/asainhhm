...
class TechnotrendsController extends HomeController
{
	...
	{	
		$technotrends = TechnoTrend::where('active_flag',1)->orderBy('id','desc')->select('url','title_tag','title','short_description')->get()->take(10);		
	...
	{	
		$technotrends = TechnoTrend::where('url',$url)->where('active_flag',1)->orderBy('id','desc')->select('title','description','id','short_description','created_at','updated_at')->first();
	...
	public function more($offset){
	 ...
	 $data = TechnoTrend::where('active_flag',1)->orderBy('id','desc')->offset($offset)->limit(10)->select('url','title_tag','title','short_description')->get();
