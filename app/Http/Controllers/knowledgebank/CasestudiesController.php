...
class CasestudiesController extends HomeController
{
	...
	{	
		$casestudies = CaseStudy::where('url',$url)->where('active_flag',1)->orderBy('id','desc')->select('pdf','title','description','url','id','short_description','created_at','updated_at')->first();
